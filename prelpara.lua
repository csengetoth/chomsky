...
function para2D(fmts)
        ...
        for i = 0, r-1 do
            ...
            for j = 1, nod do
                ...
                tex.sprint(
                    "\\node[shifting, fill=orange, anchor=north east,  inner sep=0pt,minimum size=\\N{",n,"}cm-\\pgflinewidth] at \\D{",n,"}{",x,"}{",y,"} {};")
            end
        end
    end
...
function para3D(direct, fmts)
        ...
        for i = 0, r-1 do
            ...
            ,"\\draw[leftslant, step=\\N{",n,"}cm, red] (0,0) grid (1,1);")
            for j = 1, nod do
                fmts_shift = fmts_shift +1
                x=sntnc[fmts_shift]
                fmts_shift = fmts_shift +1
                y=sntnc[fmts_shift]+1
                tex.sprint(
                "\\node[leftslant, fill=red, anchor=west,  inner sep=0pt,minimum size=\\N{",n,"}cm-\\pgflinewidth] at \\D{",n,"}{",x,"}{",y,"-.5*",x,"} {};")
            end    
            fmts_shift = fmts_shift +1    
            n=sntnc[fmts_shift]
            fmts_shift = fmts_shift +1
            ...
            tex.sprint(
                ...
                "\\draw[rightslant, step=\\N{",n,"}cm, red](0,0) grid (1,1);")
            for j = 1, nod do
                fmts_shift = fmts_shift +1
                x=sntnc[fmts_shift]
                fmts_shift = fmts_shift +1
                y=sntnc[fmts_shift]
                tex.sprint(
                    "\\node[rightslant, fill=red, anchor=north west,  inner sep=0pt,minimum size=\\N{",n,"}cm-\\pgflinewidth] at \\D{",n,"}{",x,"}{",y,"+.5*",x,"} {};")
            end    
            fmts_shift = fmts_shift +1
            n=sntnc[fmts_shift]
            fmts_shift = fmts_shift +1
            ...
            tex.sprint(
                ...
                "\\draw[topslant, step=\\N{",n,"}cm, red] (0,0) grid (1,1);")
            for j = 1, nod do
                fmts_shift = fmts_shift +1
                x=sntnc[fmts_shift]
                fmts_shift = fmts_shift +1
                y=sntnc[fmts_shift]     
                tex.sprint(
                    "\\node[topslant, fill=red, anchor=north west,  inner sep=0pt,minimum size=\\N{",n,"}cm-\\pgflinewidth] at \\D{",n,"}{",y,"-",x,"}{",tonumber(y)/2,"+.5*",x,"} {};")
           end    
    end
end
